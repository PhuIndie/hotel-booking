...
<?php 
  ...
  if(isset($_POST["submit"])) {
    if(empty($_POST["username"]) or empty(trim($_POST["password"])) or empty(trim($_POST["email"]))) {
      ...
      $insert = $conn -> prepare("INSERT INTO users(username, email, mypassword) VALUE (:username, :email, :mypassword)");
