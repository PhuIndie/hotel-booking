			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col d-flex align-items-center">
						<p class="mb-0 phone"><span class="mailus">Phone :</span> <a href="#">+84 792472529</a> or <span class="mailus">email us:</span> <a href="#">fudangit@email.com</a></p>
					</div>
	        ...
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
          		...
          		<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            		<li><a class="dropdown-item" href="<?php echo APPURL;?>/users/booking.php?id=<?php echo $_SESSION['id'];?>">Your Bookings</a></li>
            		<li><hr class="dropdown-divider"></li>
            		<li><a class="dropdown-item" href="<?php echo APPURL;?>/auth/logout.php">Sign out</a></li>
          		</ul>
       		  </li>
			  <?php endif; ?>
	        </ul>
